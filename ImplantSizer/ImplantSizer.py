...
class ImplantSizer(ScriptedLoadableModule):

  def __init__(self, parent):
    ScriptedLoadableModule.__init__(self, parent)
    self.parent.title = "Implant Sizer"  
...
class ImplantSizerWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
  ...
  def setup(self):
    ...
    uiWidget = slicer.util.loadUI(self.resourcePath('UI/ImplantSizer.ui'))
...
class ImplantSizerLogic(ScriptedLoadableModuleLogic):
...
class ImplantSizerTest(ScriptedLoadableModuleTest):
  """
  ...
  def runTest(self):
    ...
    """
    self.setUp()
    self.test_ImplantSizer1()

  def test_ImplantSizer1(self):
